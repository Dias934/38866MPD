...
public class WeatherRestful implements  WeatherApi  {
    ...
    /**
     * E.g. http://api.worldweatheronline.com/premium/v1/past-weather.ashx?q=37.017,-7.933&date=2019-01-01&enddate=2019-01-30&tp=24&format=csv&key=96ef8ba512734e27837233126202003
     *
    ...
    public Iterable<WeatherInfo> pastWeather(double lat, double log, LocalDate from, LocalDate to) {
        ...
        return map(asList(dto.getData().getWeather()),WeatherRestful::toWeatherInfo);
    }
    ...
    /**
     * e.g. http://api.worldweatheronline.com/premium/v1/search.ashx?query=Oporto&format=tab&key=96ef8ba512734e27837233126202003
     *
